// Generated from /home/gianluca/lab_compiladores/Lab02/exercicio/exerc_gramar.g by ANTLR 4.13.1
...
public class exerc_gramarParser extends Parser {
	...
	@SuppressWarnings("CheckReturnValue")
	public static class Bloco_de_instruçõesContext extends StatementContext {
		...
		public Bloco_de_instruçõesContext(StatementContext ctx) { copyFrom(ctx); }
	}
	@SuppressWarnings("CheckReturnValue")
	public static class Expressão_comumContext extends StatementContext {
		public ExprContext expr() {
			return getRuleContext(ExprContext.class,0);
		}
		public TerminalNode SEMI() { return getToken(exerc_gramarParser.SEMI, 0); }
		public Expressão_comumContext(StatementContext ctx) { copyFrom(ctx); }
	}
	@SuppressWarnings("CheckReturnValue")
	public static class Declaração_de_programaContext extends StatementContext {
		...
		public TerminalNode SEMI() { return getToken(exerc_gramarParser.SEMI, 0); }
		public Declaração_de_programaContext(StatementContext ctx) { copyFrom(ctx); }
	}
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			switch (_input.LA(1)) {
			case PROGRAM:
				_localctx = new Declaração_de_programaContext(_localctx);
				enterOuterAlt(_localctx, 1);
				{
				setState(11);
				match(PROGRAM);
				...
				break;
			case BEGIN:
				_localctx = new Bloco_de_instruçõesContext(_localctx);
			...
			case STRING:
			case ID:
				_localctx = new Expressão_comumContext(_localctx);
